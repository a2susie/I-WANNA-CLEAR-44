...
function scrMakeCircle(spawnX, spawnY, spawnLayer, spawnAngle, spawnNum, spawnSpeed, spawnObj) {
	...
	for (var i = 0; i < spawnNum; i += 1) {
		...
		if room=r11
		{
		a.sprite_index = choose(sprCherryBlue, sprCherryEmerald, sprCherryAzure, sprCherryWhite)
		}
		if room=r22
		{
		a.sprite_index = choose(sprCherryPinker,sprCherryPink)
		}
	}
}
...
function scrMakeCircleBlue(spawnX, spawnY, spawnLayer, spawnAngle, spawnNum, spawnSpeed, spawnObj) {
	var a;
	...
	for (var i = 0; i < spawnNum; i += 1) {
		...
		if room=r11
		{
		a.sprite_index = choose(sprCherryAzure)
		}
	}
}
...
for(var i = 0; i < 3; i += 1) {
    ...
    if (i == fileSelect) {
        draw_sprite(sprCherryBlack,appleIndex,xSelector+(i*xSeperation)+5,ySelector+310);
        draw_sprite(sprCherryBlack,appleIndex,xSelector+(i*xSeperation)+25,ySelector+310);
        draw_sprite(sprCherryBlack,appleIndex,xSelector+(i*xSeperation)+45,ySelector+310);
        draw_sprite(sprPlayerIdle,playerIndex,xSelector+(i*xSeperation)+65,ySelector+310);
        draw_sprite(sprCherryBlack,appleIndex,xSelector+(i*xSeperation)+85,ySelector+310);
        draw_sprite(sprCherryBlack,appleIndex,xSelector+(i*xSeperation)+105,ySelector+310);
        draw_sprite(sprCherryBlack,appleIndex,xSelector+(i*xSeperation)+125,ySelector+310);
    }
}
